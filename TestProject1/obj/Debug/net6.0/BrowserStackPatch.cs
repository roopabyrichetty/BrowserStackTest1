...
class ExecutorPatch
{
    ...
    {
        addressOfRemoteServer = new Uri("https://hub.browserstack.com/wd/hub/");
...
[HarmonyPatch(typeof(WebDriver), nameof(WebDriver.Quit))]
class QuitPatch
{
    static bool Prefix(RemoteWebDriver __instance)
    {
        try
        {
...
class PatchTest
{
    ...
    {
        return Initializer.patchMethods;
    }
